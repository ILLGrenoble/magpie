...
private:
	...
	BZCutScene<t_vec3_real, t_vec2_real, t_real> *m_bzscene = nullptr;
	BZCutView<t_vec3_real, t_vec2_real, t_real> *m_bzview = nullptr;
	...
	std::vector<std::vector<t_mat44_real>> m_sg_ops{};      // symops per space group
	sym::BZCalc<t_mat44_real, t_vec4_real, t_real> m_bzcalc{};  // calculation kernel


protected:
	// space group / symops tab
	void AddSymOpTabItem(int row = -1, const t_mat44_real& op = tl2::unit<t_mat44_real>(4));
	...
	std::vector<t_mat44_real> GetSymOps(bool only_centring = false) const;
